"""Copy of file submitted to TheAlgorithms/Python,
   except for MicroPython-ized bit_length() and commented doctest.
...
try:
    ...
    def bit_length(bint:int):
        """Position of highest non-zero bit, fairly slow.""" 
