...
from lib.core.fsutils import rel_parent_dir, path_separator, is_micropython

JFLDebug = False


class JSONFileLoader:
    """JSON file save/loader for Python and micropython file systems.
       Work in progress."""
    ...
    def prepare_types(self, json_dict: dict) -> dict:
        ...
        Most Python types convert automatically.

        set -> list
        tuple|namedtuple -> list is automatic unless
        platform is micropython and
        list[namedtuple] is value in a dictionary.
        object -> .obj__class__.__name__ """
    ...
    def restore_types(self, json_dict: dict) -> dict:
        ...
        # list -> set
        # must restore tuple|namedtuple.
        # obj__class__.__name__ -> object,
        #     saved state ?  a tuple, a couple tuples ?
